    ...
    <div class="legal-page">
        ...
        <div class="legal-content">
            <section class="legal-section">
                ...
                <p>Welcome to FoodFusion. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy policy, or our practices with regards to your personal information, please contact us at privacy@foodfusion.com.</p>
            </section>

            <section class="legal-section">
                <h2>2. Information We Collect</h2>
                <p>We collect personal information that you voluntarily provide to us when you register on the website, express an interest in obtaining information about us or our products and services, when you participate in activities on the website, or otherwise contact us.</p>
                
                <h3>Personal Information Provided by You</h3>
                <ul>
                    <li><strong>Name and contact information:</strong> We collect your first and last name, email address, and other similar contact data.</li>
                    ...
                    <li><strong>Profile information:</strong> We collect your profile picture, biography, and other details you choose to provide.</li>
                    <li><strong>Content:</strong> We collect the recipes, comments, reviews, and other content you create and share on our platform.</li>
                </ul>
            </section>
            ...
            <section class="legal-section">
                ...
                <h3>We may process or share your data that we hold based on the following legal basis:</h3>
                <ul>
            ...
            <section class="legal-section">
                ...
                <p>You have certain rights under applicable data protection laws. These may include the right to:</p>
                <ul>
            ...
            <section class="legal-section">
                <h2>8. Contact Us</h2>
                <p>If you have questions or comments about this policy, you may contact our Data Protection Officer (DPO) at:</p>
